...
#define BLYNK_TEMPLATE_NAME "Lettuce"
#define BLYNK_AUTH_TOKEN "oTGOY7dIURT8o4UD9ouR2xrfrJwvTd-3"
...
void temperature_humidity() {
  ...
  if (temp >= (TEMP_MAX + 5)) {
    Blynk.logEvent("temperature_warning", String("Attention! Greenhouse with lettuce plants experiencing temperature fluctuations. Please monitor and take action to adjust temperature accordingly to ensure optimal growth and health of the plants."));
  }
